...
<script language='javascript'>
	function check(a){
		...
		document.location="./index.php?mod=home&opt=kuisioner&angkatan="+ab;
	}
...
{
	$a = mysql_real_escape_string($_GET['angkatan']);
...
<?php 
	...
	else
	{
		...
		$que = "select nim,nama from alumni where angkatan='$angkatan' order by nama";
		$do = mysql_query($que);
...
<tr>
	...
	<td><input name="nomor6" type="radio" value="Lebih 18 Bulan">Lebih dari 18 Bulan</td>
</tr>
<tr>
	<td>7</td>
	<td>Penghasilan yang di peroleh</td>
	<td><input name="nomor7" type="radio" value="Lebih 5 Juta">lebih dari 5 Juta/bulan</td>
	...
	<td><input name="nomor7" type="radio" value="Kurang 1 Juta">Kurang dari 1 Juta/bulan</td>
</tr>
<tr>
