<?php
	...
	HeaderingExcel('LIST_DAFTAR_CALON_PESERTA_PEMAKALAH_(POSTER_PRESENTATION)_YANG_MENDAFTAR.xls');
	...
	*/
	...
	$worksheet1->write_string(2,1,"LIST DAFTAR CALON PESERTA PEMAKALAH (POSTER PRESENTATION) YANG MENDAFTAR",$fBesar);
	...
	$i=1;
	$j=1;
	$d = mysql_query("select a.id_abstrack, p.id_peserta, p.username, p.nama, p.institusi, p.negara, a.title from tbl_peserta p, tbl_abstrack a where a.id_peserta=p.id_peserta and a.jenis=2");
