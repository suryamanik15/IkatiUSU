<?php
	...
	HeaderingExcel('LIST_DAFTAR_CALON_PESERTA_BIASA_YANG_MENDAFTAR.xls');
	...
	*/
	...
	$worksheet1->write_string(2,1,"LIST DAFTAR CALON PESERTA BIASA YANG MENDAFTAR",$fBesar);
	...
	//tabel content======================================================================================
	$i=1;
	$d = mysql_query("select * from tbl_peserta where id_makalah=2 order by username asc");
