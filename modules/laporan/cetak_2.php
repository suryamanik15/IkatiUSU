<?php
	...
	HeaderingExcel('LIST_DAFTAR_CALON_PEMAKALAH_YANG_MENGIRIMKAN_ABSTRAK_YANG_TELAH_DI_DOWNLOAD.xls');
	...
	*/
	...
	$worksheet1->write_string(2,1,"LIST DAFTAR CALON PEMAKALAH YANG MENGIRIMKAN ABSTRAK YANG TELAH DI DOWNLOAD",$fBesar);
	...
	$i=1;
	$j=1;
	$d = mysql_query("select a.id_abstrack, p.username, p.nama, p.institusi, p.negara, a.title from tbl_peserta p, tbl_abstrack a where p.id_peserta=a.id_peserta and a.download=1 order by p.username");
