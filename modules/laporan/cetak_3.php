<?php
	...
	HeaderingExcel('LIST_DAFTAR_CALON_PEMAKALAH_SECARA_KESELURUHAN_YANG_TELAH_DITERIMA.xls');
	...
	*/
	...
	$worksheet1->write_string(2,1,"LIST DAFTAR CALON PEMAKALAH SECARA KESELURUHAN YANG TELAH DITERIMA",$fBesar);
	...
	$i=1;
	$j=1;
	$d = mysql_query("select a.id_abstrack, p.username, p.nama, p.institusi, p.negara, a.title, a.jenis from tbl_peserta p, tbl_abstrack a where p.id_peserta=a.id_peserta and a.terima=1 order by a.jenis asc, p.username asc");
