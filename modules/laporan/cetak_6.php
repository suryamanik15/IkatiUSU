<?php
	...
	HeaderingExcel('LIST_DAFTAR_PAPER_DARI_CALON_PEMAKALAH_SECARA_KESELURUHAN YANG_TELAH_DITERIMA_YANG_TELAH_DI_DOWNLOAD.xls');
	...
	*/
	...
	$worksheet1->write_string(2,1,"LIST DAFTAR PAPER DARI CALON PEMAKALAH SECARA KESELURUHAN YANG TELAH DITERIMA YANG TELAH DI DOWNLOAD",$fBesar);
	...
	$i=1;
	$j=1;
	$d = mysql_query("select a.id_abstrack, p.username, p.nama, p.institusi, p.negara, a.title, a.jenis from tbl_peserta p, tbl_abstrack a, tbl_paper r where p.id_peserta=a.id_peserta and a.terima=1 and r.download=1 and a.id_abstrack=r.id_abstrack order by a.jenis asc, p.username asc");
